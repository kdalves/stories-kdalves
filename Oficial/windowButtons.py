...
video = tk.Button(master=window, text= "Câmera \nFiltros", bg='#6824a3', fg="white", command=lambda: video(), padx=10, pady=15, justify=CENTER).place(x=100, y=300)
changeCamera = tk.Button(master=window, text= "Mudar \nCâmera", bg='#6824a3', fg="white", command=None, padx=10, pady=15, justify=CENTER).place(x=250, y=100)
cameraFiltroAccessory = tk.Button(master=window, text= "Câmera \nAcessório", fg="white", bg='#6824a3', command=lambda: accessory(), padx=10, pady=15, justify=CENTER).place(x=250, y=300)
