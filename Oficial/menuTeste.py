...
import cv2
import colorFilter
# import openVideo as ov
from testeAbreVideoEImagem import MainWindow
# import imageFilter
...
def openNewWindow():
    ...
    newWindow.title("Adicionar Acessorio")
    newWindow.geometry("600x600")
    newWindow.wm_iconbitmap('Icons/instakath.ico')

    Label(newWindow, text ="Teste Vídeo").pack()
    MainWindow(newWindow, cv2.VideoCapture(0))
...
tk.Button(master=window, image= galleryImage, text= "Imagem \nFiltros", bg='#6824a3', fg="white", command=lambda: imageFilter(), padx=10, pady=15, justify=CENTER).place(x=100, y=100)
tk.Button(master=window, image= cameraImage, text= "Câmera \nFiltros", bg='#6824a3', fg="white", command=lambda: video(), padx=10, pady=15, justify=CENTER).place(x=100, y=200)
tk.Button(master=window, image= changeCameraImage, text= "Mudar \nCâmera", bg='#6824a3', fg="white", command=lambda: changeVideo(), height=48, padx=10, pady=5, justify=CENTER).place(x=100, y=300)
tk.Button(master=window, image= hatAccessory, text= "Câmera \nAcessório", fg="white", bg='#6824a3', command= openNewWindow, height=48 ,padx=10, pady=15, justify=CENTER).place(x=100, y=400)
# tk.Button(master=window, image= hatAccessory, text= "Câmera \nAcessório", fg="white", bg='#6824a3', command=lambda: accessory(), height=48 ,padx=10, pady=15, justify=CENTER).place(x=100, y=400)
